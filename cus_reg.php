<?php
    ...
    if($_POST)      
    {
        ...
        if(count($errors) == 0)
        {
            ...
            $sql = "INSERT INTO customer (_name, _email,_password,_balance) VALUES ('$user_name','$email', '$pass','$balance')";
	...
	<ul id="dc_mega-menu-orange" class="dc_mm-orange">
	  ...
	  <div class="clear"></div>
		...
		<form method="POST" target="">
            ...
            <input type="text" name="Name" id="Name" placeholder="Enter your User Name..." value="<?php if(isset($_POST['Name'])) echo $_POST['Name']; ?>" /> 
            </p>
