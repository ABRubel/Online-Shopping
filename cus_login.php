...
if($_POST)
{
  ...
  if(empty($_Name))$errors['name_err']="Email can't be empty!!";
  if(empty($_password))$errors['pass_err']="Password can't be empty!!";
include 'db_connection.php';

  $sql=" select * 
  		 from customer
  		 where _email= '$_Email' and _password = '$_password' ";
